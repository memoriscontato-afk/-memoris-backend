...
function gerarUrlPagina(pedidoId) {
  // BACKEND_URL é dedicado para o link da homenagem (onde a rota /homenagem existe de fato)
  // Não usar FRONTEND_URL aqui — essa é usada pelo CORS e aponta pro site do cliente (Netlify)
  const base = process.env.BACKEND_URL || 'https://memoris-backend-production-f440.up.railway.app';
...
<div style="max-width:560px;margin:0 auto;padding:40px 20px;">
  ...
  <div style="text-align:center;margin-top:24px;color:rgba(59,42,32,.4);font-size:12px;line-height:1.7;">
    ...
    <p style="margin:0;">Dúvidas? <a href="mailto:memoriscontato@gmail.com" style="color:#9A4B2F;">memoriscontato@gmail.com</a></p>
...
async function enviarQRCode({ pedido, fotos }) {
  try {
    ...
    const { error } = await resend.emails.send({
      from:        'Memoris <noreply@memorisqr.com.br>',
      reply_to:    'memoriscontato@gmail.com',
      to:          pedido.email,
