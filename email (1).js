...
<div style="max-width:560px;margin:0 auto;padding:40px 20px;">
  ...
  <div style="background:#fff;border-radius:16px;padding:36px 32px;box-shadow:0 4px 20px rgba(59,42,32,.08);">
    ...
    <div style="display:flex;flex-direction:column;gap:10px;">
      ${[
        '📱 Escaneie o QR Code com a câmera do celular — a homenagem abre na hora.',
        ...
        '🔑 Leve para uma gráfica e peça um chaveiro acrílico — presente pra vida toda.'
      ].map(t => `<p style="margin:0;font-size:13px;color:rgba(59,42,32,.7);padding:8px 12px;background:#F9F5EE;border-radius:8px;">${t}</p>`).join('')}
    </div>
  </div>
